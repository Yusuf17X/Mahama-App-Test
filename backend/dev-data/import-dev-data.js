...
const importData = async () => {
  try {
    ...
    console.log(
      `  • Total: ${importedSchools.length + importedChallenges.length + importedBadges.length + importedUsers.length + importedUserChallenges.length + importedUserBadges.length} records\n`,
    );
  } catch (err) {
